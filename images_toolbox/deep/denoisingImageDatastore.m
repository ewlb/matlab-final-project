...
%                               Default: 50.
%
%   GaussianNoiseLevel        : Specifies the Gaussian noise standard
%                               deviation as a fraction of the image class
%                               maximum. It can be a scalar signifying a
%                               single noise level or a vector of two
%                               elements specifying the maximum and minimum
%                               noise standard deviations. When it is a
%                               vector, the range of noise standard
%                               deviation is uniformly sampled to identify
%                               a noise level for a particular patch.
%                               Default: 0.1.
%
...
%
%   net = trainnet(ds,layers,"mse",opts);
%
...
classdef denoisingImageDatastore < ...
    ...
    methods(Access=protected)
        ...
        function newds = subsetByReadIndices(self,indices)
            newds = partitionByIndex(self, indices);
        end
