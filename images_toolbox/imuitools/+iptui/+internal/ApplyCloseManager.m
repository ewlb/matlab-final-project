classdef ApplyCloseManager < handle
    ...
    methods
        function self = ApplyCloseManager(hTab,varargin)
            ...
            self.ApplyButton = matlab.ui.internal.toolstrip.Button(applyLabel,matlab.ui.internal.toolstrip.Icon('validated'));
            self.ApplyButton.Tag = 'btnApply';
            self.ApplyButton.Description = applyTooltip;
            
            self.CloseButton = matlab.ui.internal.toolstrip.Button(closeLabel,matlab.ui.internal.toolstrip.Icon('close'));
