...
%
%   'Color'                
%       Specifies the color of the boundary using a 1x3 RGB triplet which 
%       must be normalized to the range [0,1]. A string or character vector 
%       corresponding to one of the valid inputs to the MATLAB colormap 
%       function is also accepted. For example, valid specifications for a 
%       red fill color are: 'red','r', and [1 0 0]. Default color is red.
%
%   'LineStyle'
%       Specifies the line style for the boundary. The line style can be
...
% Validate EnhanceVisibility value. Others will be validate by LINE.
