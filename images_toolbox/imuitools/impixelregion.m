...
images.internal.legacyui.utils.suppressPlotTools(hPixelRegionFig);
...
set(hPixelRegionIm,'ButtonDownFcn',@images.internal.legacyui.utils.impan);
...
images.internal.legacyui.utils.reactToImageChangesInFig(hIm,hPixelRegionFig,...
...
if ~isdeployed
    helpIcon = images.internal.legacyui.utils.makeToolbarIconFromGIF(...
...
uimenu(filemenu,...
    ...
    'Callback', @(obj,evt) images.internal.legacyui.utils.printImageToFigure(sp_h));
...
function showPixelRegionHelp(varargin)
    ...
    helpview("images", "pix_region_tool_help");
