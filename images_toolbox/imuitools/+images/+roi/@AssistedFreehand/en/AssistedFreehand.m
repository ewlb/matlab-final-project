...
%
%
%    AssistedFreehand events:
%
%    AddingWaypoint    Event to notify when a waypoint has been 
%                      interactively added to the ROI.
%
%    WaypointAdded     Event to notify when a waypoint is about to be 
%                      interactively added to the ROI.
%
%    RemovingWaypoint  Event to notify when a waypoint is about to be 
%                      interactively removed from the ROI.
%
%    WaypointRemoved   Event to notify when a waypoint has been 
%                      interactively removed from the ROI.
%
