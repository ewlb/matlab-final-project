...
set(tool_fig,'Name',images.internal.imcontrast.createFigureName(tool_name,target_fig));
...
function cbFun = getUpdateNameCallbackFun(tool_fig,target_fig,tool_name)
 ...
 cbFun = @(hobj,evt) set(tool_fig,'Name',images.internal.imcontrast.createFigureName(tool_name,target_fig));