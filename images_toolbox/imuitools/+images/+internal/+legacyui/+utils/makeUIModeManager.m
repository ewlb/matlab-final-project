...
%   callback that is fired prior to a proposed mode change. modeChangedCallback
%   is a function handle with the signature:
%
...
%   Copyright 2005-2023 The MathWorks, Inc.  
  ...
  modeManager = images.internal.legacyui.utils.makeExclusiveModeManager();
  
  activateDefaultMode = modeManager.addMode(makeDefaultModeCurrent,...
                                            images.internal.legacyui.utils.identityFcn);
