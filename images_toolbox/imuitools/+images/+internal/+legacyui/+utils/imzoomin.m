...
%   Copyright 2004-2023 The MathWorks, Inc.
  ...
  hIm = obj;
  hScrollpanel = images.internal.legacyui.utils.checkimscrollpanel(hIm,mfilename,'HIMAGE');
  ...
  if singleClick
    ...
    [x, y] = images.internal.app.utilities.getCurrentPoint(hAx);  
  ...
  function buttonReleased(~,varargin)
      ...
      if altKeyPressed
          ...
          [x2, y2] = images.internal.app.utilities.getCurrentPoint(hAx);
  ...
  function drawRectangleWhileMoving(~, varargin)
    ...
    [xCurrent, yCurrent] = images.internal.app.utilities.getCurrentPoint(hAx);
