classdef Icon < handle
    ...
    methods (Static)
        ...
        function icon = ASSISTED_FREEHAND_24
            fname = fullfile(matlabroot, 'toolbox/images/icons', 'draw_assistedFreehand_24.png');
            icon = matlab.ui.internal.toolstrip.Icon(fname);
        end
        function icon = CIRCLE_24
            fname = fullfile(matlabroot, 'toolbox/images/icons', 'draw_circle_24.png');
            icon = matlab.ui.internal.toolstrip.Icon(fname);
        end
        ...
        function icon = EDIT_16
            fname = fullfile(matlabroot, 'toolbox/images/icons', 'edit_16.png');
            icon = matlab.ui.internal.toolstrip.Icon(fname);
        end
        
        function icon = EDIT_24
            fname = fullfile(matlabroot, 'toolbox/images/icons', 'edit_24.png');
            icon = matlab.ui.internal.toolstrip.Icon(fname);
        end
    end
