classdef ColorSpaceProjectionView < handle
    ...
    methods
        ...
        function self = ColorSpaceProjectionView(hPanel,hFig,RGB,csname,camPosition,camVector,rgbColor,isHidden)
            ...
            self.hRotate3DListener = addlistener(hFig,'WindowMousePress',@(hObj,evt) reactToMousePress(evt));
...
if ~isempty(currentObject) && isprop(currentObject,'Tag') && strcmp(get(currentObject,'Tag'),'scatteraxes')          
