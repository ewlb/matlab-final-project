classdef ImageCaptureTab < images.internal.app.colorThresholder.AbstractTab
...
% Copyright 2014-2019 The MathWorks, Inc.
    ...
    methods (Access=public)
        ...
        function this = ImageCaptureTab(tool)
            this = this@images.internal.app.colorThresholder.AbstractTab(tool, ...
    ...
    methods(Access=private)
        ...
        function createPropertiesPanel(this)
            ...
            if isempty(this.PropertiesPanel) % We have to create a new one.
                this.PropertiesPanel = images.internal.app.colorThresholder.CameraPropertiesPanel(this.CameraObject, tool.ImagePreviewDisplay);
            else
