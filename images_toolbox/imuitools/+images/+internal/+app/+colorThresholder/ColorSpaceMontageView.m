classdef ColorSpaceMontageView < handle
    ...
    methods
        ...
        function self = ColorSpaceMontageView(hToolGroup,RGB,rgbColor,rotatePointer)
            ...
            addlistener(self.hFig,'WindowMousePress',@(hObj,evt) reactToMousePress(evt));
...
function reactToMousePress(evt)
...
hAx.XLim = images.internal.app.colorThresholder.setAxesLimits(hScat.XData);
hAx.YLim = images.internal.app.colorThresholder.setAxesLimits(hScat.YData);
hAx.ZLim = images.internal.app.colorThresholder.setAxesLimits(hScat.ZData);
set(hAx,'box','on',...
    'Color',rgbColor,...
    'XColor',[0.5 0.5 0.5],...
    'YColor',[0.5 0.5 0.5],...
