function generateColorSegmentationCode(hToolGroup)
    ...
    if images.internal.app.colorThresholder.hasValidROIs(hToolGroup.hFigCurrent,hToolGroup.hPolyROIs) && ~hToolGroup.hHidePointCloud.Value
    ...
    if images.internal.app.colorThresholder.hasValidROIs(hToolGroup.hFigCurrent,hToolGroup.hPolyROIs) && ~hToolGroup.hHidePointCloud.Value
        ...
        hROIs = images.internal.app.colorThresholder.findROIs(hToolGroup.hFigCurrent,hToolGroup.hPolyROIs);
