function cmap = colorOrder
% For internal use only

% Copyright 2019-2024 The MathWorks, Inc.

% The first row should be black to correspond to the <undefined> label.
% Rows 2-8 are the MATLAB graphics color order as defined by parula
% Rows 9-33 are derived from the MATLAB graphics extended color palette as
% defined by parula.
% The remaining rows are randomly generated to be distinct from other
% colors

% UIs only support 255 labels right now
maxLabelsAllowed = 256;

cmap = single(getHardCodedColorMap(maxLabelsAllowed));

end

function cmap = getHardCodedColorMap(n)

cmap = [
    % Black for background label
         0         0         0

    % MATLAB Graphics color order without the first blue color
    0.8667    0.3294         0
    0.9294    0.6941    0.1255
    0.5216    0.0863    0.8196
    0.2314    0.6667    0.1961
    0.1843    0.7451    0.9373
    0.8196    0.0157    0.5451

    % Expanded graphics color order
    0.3804    0.0353    0.0314
    1.0000    0.8510    0.7176
    0.7020    0.5333    0.1647
    0.8392    0.5804    1.0000
    0.7961    1.0000    0.7451
    0.0902    0.4627    0.6471
    0.9490    0.4039    0.7725
    0.7176    0.1922    0.1725
    0.7882    0.9059    1.0000
    0.5098    0.2039         0
    1.0000    0.8588    0.6039
    0.9529    0.8902    1.0000
    0.0078    0.3451    0.0549
    0.4235    0.9569    1.0000
    0.5882         0    0.3922
    1.0000    0.6157    0.6039
    0.0627    0.2588    0.5020
    1.0000    0.6706    0.4000
    1.0000    0.9216    0.7176
    0.3686    0.1333    0.5882
    0.5804    0.9373    0.5176
    0.7686    1.0000    1.0000
    1.0000    0.2706    0.2275
    1.0000    0.8588    0.9490

    % Blue color from the MATLAB graphics color order. This color clashes
    % with the volshow background and should not be a principal color
    0.0667    0.4431    0.7451

    % Randomly generated colors to be distinct from other colors
...
if n > size(cmap,1)
    cmap = [cmap; rand([n - size(cmap,1),3])];
elseif n < size(cmap,1)
    cmap = cmap(1:n,:);
end
