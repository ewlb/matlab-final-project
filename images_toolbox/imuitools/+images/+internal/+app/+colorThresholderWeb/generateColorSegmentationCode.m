function generateColorSegmentationCode(hToolGroup)
    ...
    if images.internal.app.colorThresholderWeb.hasValidROIs(hToolGroup.hFigCurrent,hToolGroup.hPolyROIs) && ~hToolGroup.hHidePointCloud.Value
    ...
    if images.internal.app.colorThresholderWeb.hasValidROIs(hToolGroup.hFigCurrent,hToolGroup.hPolyROIs) && ~hToolGroup.hHidePointCloud.Value
        ...
        hROIs = images.internal.app.colorThresholderWeb.findROIs(hToolGroup.hFigCurrent,hToolGroup.hPolyROIs);
