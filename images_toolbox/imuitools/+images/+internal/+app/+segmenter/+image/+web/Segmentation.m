classdef Segmentation < handle
    ...
    methods
        function self = Segmentation(hApp_)
            self.hApp = hApp_;
            self.History = images.internal.app.segmenter.image.web.History(hApp_.getHistoryBrowser());
            self.Dirty = false;
        ...
        function newSegmentation = deepCopy(self)
            newSegmentation = images.internal.app.segmenter.image.web.Segmentation(self.hApp);
    ...
    methods (Hidden = true)
        ...
        function addToHistory_(self, newMask, description, command)
            tmpMask = images.internal.app.segmenter.image.web.MaskView(newMask);
