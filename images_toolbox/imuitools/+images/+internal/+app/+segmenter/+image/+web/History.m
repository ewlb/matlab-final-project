classdef History < handle
    ...
    methods
        ...
        function copiedSelf = copy(self)
            copiedSelf = images.internal.app.segmenter.image.web.History(self.hHistoryBrowser);
            ...
            for index = 1:numThumbnails
                copiedSelf.ThumbnailFilenames{index} = ...
                    images.internal.app.segmenter.image.web.createThumbnail(self.Masks{index}.getMask());
            end
        end
        ...
        function addAtCurrent(self, newMaskView, description, command)
            ...
            self.ThumbnailFilenames{idx} = ...
                images.internal.app.segmenter.image.web.createThumbnail(newMaskView.getMask());
    ...
    methods
        ...
        function TF = get.HasPaintBrush(self)
            TF = any(strcmp(getString(message('images:imageSegmenter:paintBrushComment')),self.Descriptions));
        end
    ...
    methods (Access=private)
        function trimAfter(self, lastItemToKeep)
            ...
            self.ThumbnailFilenames(firstToClear:end) = [];
