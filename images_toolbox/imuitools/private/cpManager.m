...
pairIdStream = images.internal.legacyui.utils.idStream(initialId);
...
pairsChanged
  ...
  % Use dynamic field names to fill in appropriate fields of inputBasePairs
  ...
  function newPairId = makeNewPair
    ...
    % Make new pair, add it to inputBasePairs extending the structure array by
