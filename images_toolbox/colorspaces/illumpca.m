...
%   the 3.5% darkest and brightest colors, according to this ordering, are
...
%     % and brightest 3.5% of pixels. Note that, since the
...
% Share of darkest and brightest colors to use
