...
%
%   BPS is a numeric scalar or a gpuArray that specifies the actual number
%   of bits required to represent each channel of the input. It can take
%   values 10 or 12.
%
%   Class Support
%   -------------
%   YCBCR must contain uint16 data. The output RGB will be a gpuArray
...
%
%      YCBCRLIST = gpuArray(uint16([3760 2048 2048]));
...
%
%      YCBCR = gpuArray(reshape(uint16([64 512 512; 940 512 512]), [2 1 3]));
%      RGB = ycbcr2rgbwide(YCBCR, gpuArray(10));
%
%   References:
%   ----------
...
%       PROGRAMME EXCHANGE"
%
%   See also GPUARRAY/RGBWIDE2YCBCR, GPUARRRAY/RGB2YCBCR, GPUARRAY/YCBCR2RGB.
