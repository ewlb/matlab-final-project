...
if ismatrix(I)
    ...
    intI = images.internal.builtins.integralimage(I);
       
    T = images.internal.builtins.boxfilter(intI, nhoodSize, normFactor, 'double', outSize);
else
    intI = integralImage3(I);
       
    T = images.internal.builtins.boxfilter3(intI, nhoodSize, normFactor, 'double', outSize);
end
