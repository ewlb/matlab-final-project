...
[uv, xy, method, options] = ParseInputs(args{:});
...
trans = maketform('custom',2,2,[],@(varargin) images.internal.builtins.inv_piecewiselinear(varargin{:}),tdata);
...
trans = maketform('custom',2,2,[],@(varargin) images.internal.builtins.inv_lwm(varargin{:}),tdata);
