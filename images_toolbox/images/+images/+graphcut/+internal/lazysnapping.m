classdef lazysnapping < images.graphcut.internal.graphcut
    ...
    methods(Access = 'protected')
        ...
        function [foregroundWeights, backgroundWeights] = computeTerminalEdgeWeights(self)
            ...
            minDistanceToForegroundColor = ...
                images.internal.builtins.minpdist2(self.ForegroundScribbleColor,self.MeanFeatures);
            minDistanceToBackgroundColor = ...
                images.internal.builtins.minpdist2(self.BackgroundScribbleColor,self.MeanFeatures);
