...
%   B = images.compatibility.imsharpen.r2021b.imsharpen(A) returns an enhanced
%   version of the grayscale or truecolor input image A where the image features,
%   such as edges, have been sharpened using the unsharp masking method.
%
%   B = images.compatibility.imsharpen.r2021b.imsharpen(__,NAME1,VAL1,...) 
