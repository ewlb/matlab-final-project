...
%   Copyright 2014-2020 The MathWorks, Inc.
    ...
    methods
        ...
        function obj = segment(obj,labelIdx,varargin)
            ...
            % Set flag that an initial segmentation has been done. This
        ...
        function obj = updateSegments(obj, whichLabel, newIdxs, varargin)
            ...
            for currLabel = 1:obj.numLabels
                ...
                Dnewpointlabel = ...
                    images.internal.builtins.fastmarching(wTemp1, newIdxs-1);

                wTemp2 = obj.W(:,:,currLabel);
                wTemp2(isOutSideCurrLabel) = 0;
                Dcurrlabel = images.internal.builtins.fastmarching(...
                                                      wTemp2, newIdxs-1);
    ...
    methods(Hidden, Access = private)
        ...
        function D = calcGeodesicDistanceForLabels(obj, varargin)
            ...
            for i = 1:size(wForGeodDist,3)
                D(:,:,i) = images.internal.builtins.fastmarching(...
                                                    wForGeodDist(:,:,i), obj.labelIdx{i}-1);
            end
