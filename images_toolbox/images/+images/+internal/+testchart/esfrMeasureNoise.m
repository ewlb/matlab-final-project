...
for i = 1:numPatches
    ...
    noise_meas_Y(i) = std2(double(imChroma(ROI(2):ROI(2)+ROI(4)-1,ROI(1):ROI(1)+ROI(3)-1,1)));
    noise_meas_Cb(i) = std2(double(imChroma(ROI(2):ROI(2)+ROI(4)-1,ROI(1):ROI(1)+ROI(3)-1,2)));
    noise_meas_Cr(i) = std2(double(imChroma(ROI(2):ROI(2)+ROI(4)-1,ROI(1):ROI(1)+ROI(3)-1,3)));
end
