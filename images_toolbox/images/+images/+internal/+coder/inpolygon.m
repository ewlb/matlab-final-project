...
% Check whether points are inside, on, or outside polygon
...
% Find the points that lie strictly inside the polygon
...
%   @out: sign of cross products and dot products between adjacent vertices
