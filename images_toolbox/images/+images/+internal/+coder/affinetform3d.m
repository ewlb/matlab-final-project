%   This affinetform3d class contains code generation implementation of affinetform3d
...
classdef affinetform3d < images.geotrans.internal.affinetform3dImpl & ...
    ...
    methods
        ...
        %     Constructor
        %------------------------------------------------------------------
        function this = affinetform3d(varargin)
            this = this@images.geotrans.internal.affinetform3dImpl(varargin{:});
            data = {images.geotrans.internal.affinetform3dImpl(varargin{:})};
