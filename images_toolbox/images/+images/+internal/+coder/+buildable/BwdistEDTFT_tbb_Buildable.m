        ...
        function updateBuildInfo(buildInfo, context)
            ...
            switch arch
                case {'win32','win64'}
                    ...
                    nonBuildFiles = {'libmwbwdistEDTFT_tbb','tbb12','tbbmalloc'}; %#ok<*EMCA>
                ...
                case {'glnxa64','maci64','maca64'}
                    ...
                    if strcmp(arch,'glnxa64')
                        ...
                        nonBuildFilesNoExt = {'libtbb.so.12','libtbbmalloc.so.2'};
                    ...
                    elseif strcmp(arch,'maci64')
                        ...
                        libstdcpp          = [];
                        nonBuildFilesNoExt = {'libtbb.12','libtbbmalloc.2'};
                        nonBuildFilesNoExt = strcat(binArch,nonBuildFilesNoExt,execLibExt);
                    end
