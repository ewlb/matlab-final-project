function [A, ref, C, exponents, radius, filtSize, dataformat] = ssimParseInputs(varargin)
...
A = varargin{1};
validateattributes(A,validImageTypes,{'nonsparse','real'},'ssim','A',1);

ref = varargin{2};
validateattributes(ref,validImageTypes,{'nonsparse','real'},'ssim','REF',2);
