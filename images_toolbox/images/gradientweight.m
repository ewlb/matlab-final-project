...
[minI,maxI] = bounds(I,'all');

if isinteger(I)
    maxI = double(maxI);
    minI = double(minI);
end
% Rough number of floating point operations in this function is ~100. Add
% buffer.
if maxI-eps(maxI)*1000<=minI
    % Input is practically constant
    ...
    W = images.internal.imlinscale(W);
