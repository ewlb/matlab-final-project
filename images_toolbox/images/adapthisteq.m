...
%   values in the intensity image.  Unlike HISTEQ, it operates on small
...
%
%   'NumTiles'     Two-element vector of positive integers of double data type: [M N].
...
%                  Default: [8 8].
%
%   'ClipLimit'    Real scalar of double data type from 0 to 1.
%                  'ClipLimit' limits contrast enhancement. Higher numbers
%                  result in more contrast.
%
%                  Default: 0.01.
%
%   'NBins'        Positive integer scalar of double data type.
...
%                  Default: 'uniform'.
%
%   'Alpha'        Nonnegative real scalar of double data type.
  ...
  while ~done
    ...
    switch inputStr
     ...
     case 'Range'
      ...
      if strncmpi(rangeStr,'original',numel(rangeStr))
