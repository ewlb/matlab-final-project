...
pthetaDeg = formPthetaVector(dpthetaDeg, args.ParallelCoverage);
...
if isFanCoverageCycle
    ...
    Fpad = padarray(F,[0 length(1:n4)],'circular');    
    thetapad = [thetaDeg(end-n4+1:end)-360 thetaDeg thetaDeg(1:n4)+360];   
...
%------------------------------------------
function ptheta = formPthetaVector(dptheta, parallelCoverage)
if strcmp(parallelCoverage,'cycle')
