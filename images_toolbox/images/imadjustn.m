...
%   J = IMADJUSTN(V) maps the values in nD intensity volumetric image V to
%   new values in J such that 1% of data is saturated at low and high
%   intensities of V. This increases the contrast of the output volumetric
%   image J.
%
%   J = IMADJUSTN(V,[LOW_IN; HIGH_IN],[LOW_OUT; HIGH_OUT]) maps the values
%   in intensity volumetric image V to new values in J such that values
...
%   Class Support
%   -------------
%   The nD input volumetric image V can be uint8, uint16, int16, double or
%   single. The output image has the same class as the input image.
%
%   Examples
%   --------
