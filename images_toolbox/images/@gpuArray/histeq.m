...
if(isfloat(im))
    ...
    nLevelsIn = diff(getrangefromclass(im)) + 1;    
end  
...
imout = applyTransformation(im,T, nLevelsIn);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function out = applyTransformation(im,T, nLevelsIn)
%Apply gray-level transformation defined in T to im.

classname = underlyingType(im);
nLevels   = nLevelsIn-1;
