...
validateattributes(T,{'logical','numeric'},{'real','2d', 'finite','nonsparse'},...
    mfilename,'T',1);
validateattributes(A,{'logical','numeric'},{'real','2d', 'finite','nonsparse'},...
    mfilename,'A',2);
...
is_unsigned = ismember(underlyingType(A), {'uint8','uint16','uint32'});
if ~is_unsigned
