...
%      colormap(gca,hot);
%
%   See also HOUGHPEAKS, HOUGHLINES.
...
%   'ThetaResolution' is not recommended. The help text below can help you
%   understand existing code that uses 'ThetaResolution'. Consider updating
%   your code to use 'Theta' instead.
%
...
h = images.internal.builtins.hough(bw,rho,theta*pi/180);
