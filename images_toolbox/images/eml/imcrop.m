...
% Use if-else flow control instead of switch to workaround varsize output
% issue (g2136569)
% with fixed sized inputs.
if(nargin==2)
    % [...] = imcrop(I,rect)
    ...
    coder.internal.errorIf(nargin ~= 4, 'images:imcrop:unsupportedCodegenSyntax');
