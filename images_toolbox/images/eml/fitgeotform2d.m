function tform = fitgeotform2d(movingPoints,fixedPoints,transformationType,varargin)%#codegen
%fitgeotform2d Fit geometric transformation to control point pairs.
...
coder.internal.errorIf(~coder.internal.isConst(transformationType),...
    'images:geotrans:coderTransformationTypeNotConst')
...
trans2 = affinetform2d(TreflectY * trans2r.T');
