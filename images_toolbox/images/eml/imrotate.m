    ...
    if rem(ang,90) == 0
        ...
        switch multiple_of_ninety
            ...
            case 2
                ...
                % GPU Enabled condition is added here. Added rowmajor flag for this 180 rotation case by 
                % swapping the loops for GPU Code generation.
                if coder.gpu.internal.isGpuEnabled && coder.isRowMajor
...
% occurrence is used. e.g. For imrotate(I,40,'crop','loose'), bbox is set to
