...
%   % MULTITHRESH and applies those thresholds to the image using 
%   % IMQUANTIZE to get segment labels.
%  
...
%     imshow(I)
% 
%     % Obtain 7 thresholds from MULTITHRESH to split the image into 8
%     % levels
%     thresh = multithresh(I,7);
% 
%     % Reduce the number of levels using the maximum value in each 
%     % interval to replace the values in I
