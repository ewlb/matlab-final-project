...
%   Computer Vision Toolbox instead.
%
...
validateattributes(I, {'uint8', 'double', 'logical', 'int16', 'single', 'uint16',...
    'uint32', 'int32', 'int8'}, {'real', 'finite', 'nonsparse'}, mfilename, 'chkImg', 1);
