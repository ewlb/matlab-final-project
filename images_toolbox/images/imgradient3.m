...
%   Example
%   ---------
%   % Computes 3-D gradient magnitude and direction using Sobel's gradient
%   % operator
%       volData = load('mri');
%       sz = volData.siz;
...
if (isempty(I))
    ...
    if(nargout<2)
        Gmag = images.internal.builtins.imgradient3(I,method);
    else
        [Gmag, Gazimuth, Gelevation] = images.internal.builtins.imgradient3(I,method);
    end
end
