...
%   
%   disp(['BRISQUE score for original image is ', num2str(brisqueI)]);
%   disp(['BRISQUE score for noisy image is ', num2str(brisqueInoise)]);
%   disp(['BRISQUE score for blurry image is ', num2str(brisqueIblur)]);
%
