...
%   the principal semi-axes in rows, columns and planes in H or it can be
...
%   smoothing effect in the other directions. 'Direction' can be a string or
...
%   preferred syntax.
%   
%   The principal semi-axes in ellipsoidal filter correspond to the
...
[type, Hsize, sigma, gamma, direction ] = ParseInputs(args{:});
...
switch nargin
    ...
    case 2
       ...
       switch type
           ...
           case 'laplacian'
               validateattributes(Hsize,{'double'},{'nonnegative','nonsparse','real',...
                   'finite','scalar','<=',1},...
                   mfilename,'GAMMA1',2);              
               gamma = [Hsize 0];
           case 'ellipsoid'
        ...
        switch type
            ...
            case 'laplacian'
                ...
                validateattributes(Hsize,{'double'},{'nonnegative','nonsparse','real',...
                    'finite','scalar'},...
                    mfilename,'GAMMA1',2);
                validateattributes(sigma,{'double'},{'nonnegative','nonsparse','real',...
                    'finite','scalar'},...
                   mfilename,'GAMMA2',2);
                gamma = [Hsize sigma];
            if (sum(gamma) > 1)
