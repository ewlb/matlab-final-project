...
%   Example 1
%   ---------
%   % Compute superpixels of input RGB image. Form an output image where 
%   % each pixel is set to the mean color of its corresponding superpixel 
%   % region.
%   
%   A = imread('kobi.png');
...
[L,N] = images.internal.builtins.slic(options.A,...
    options.N,...
    options.Compactness,...
