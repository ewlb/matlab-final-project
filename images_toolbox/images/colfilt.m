...
%
%   BLOCK_TYPE is a string or char vector with one these values:
%
...
%      FUN           - function handle
%      BLOCK_TYPE    - string or char vector; either 'sliding' or 'distinct'
%      MBLOCK,NBLOCK - double, integer scalars
%   OUT
...
validateattributes(varargin{2},{'numeric'},{'finite','positive','integer'});
nhood = cast(varargin{2},'double');
