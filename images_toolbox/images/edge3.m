...
% volshow(BW);
%
% See also EDGE, FSPECIAL3, IMGRADIENTXYZ.
...
if strcmp(method,'approxcanny')
    ...
    eout = cast(images.internal.builtins.canny3_itk(V, lowThresh, highThresh, sigma.^2), 'logical');
...
elseif strcmp(method,'sobel')
    ...
    if thinning
        eout = images.internal.builtins.computeEdges3(b,bx,by,bz,kx,ky,kz,int8(offset),100*eps,cutoff);
    else
        eout = b > cutoff;
    end
