...
readPixels = false;
readAllMeta = true;
rawAttributes = images.internal.builtins.dicomparse(fileDetails.name, ...
                           fileDetails.bytes, ...
                           getEndian(), ...
                           readPixels, ...
                           dicomdict('get'), ...
...
uidDetails = images.internal.dicom.dicom_uid_decode(UID);
...
tf = any(data(1:end-1) < printableASCIIRange(1)) || ... % Use end-1 to accommodate whitespace.
